...
// Circularly Singly Linked List class
class CircularSinglyLinkedList {  //定義名為CircularDoublyLinkedList的類型
private:                          //宣告私有變數
    Node* head;                   //宣告head指標指向第一個
    Node* tail;                   //宣告tail指標指向最後一個節點

public:                           //宣告公有變數
    CircularSinglyLinkedList() {  //定義CircularSinglyLinkedList類型初始化的節點數值成員
    ...
    void print() {                                      //宣告print函式 
        if (head == nullptr) {                          //判斷頭節點為空
            ...
            cout << "Circularly Singly Linked List: ";  //輸出Circularly Singly Linked List: 
            do {                                        //在while迴圈執行前重複執行 
...
// Main function to test the Circularly Singly Linked List
int main() {                                    //主程式
    CircularSinglyLinkedList list;              //宣告名為list的CircularSinglyLinkedList
